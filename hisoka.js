...
case 'meme': {
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapis.xyz/randomimage/meme?apikey=sonelstore`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
case 'darkjoke': case 'darkjokes': {
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapis.xyz/randomimage/darkjoke?apikey=sonelstore`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
case 'memeindo': {
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapis.xyz/randomimage/memeindo?apikey=sonelstore`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
...
╰──── 
╭─[ *MINAT CHAT📌*]
│❏ ➪ 🪀 _wa.me/6288221255023?text=SEWA+BOT_
╰────
╭─[ *PAYMENT💰*]
│❏ ➪ _GOPAY_
│❏ ➪ _DANA_
